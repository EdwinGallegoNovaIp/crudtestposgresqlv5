...
@RestController
@RequestMapping("/api/crudtestposgresqlv-5-kafka")
public class Crudtestposgresqlv5KafkaResource {

    private final Logger log = LoggerFactory.getLogger(Crudtestposgresqlv5KafkaResource.class);
    ...
    public Crudtestposgresqlv5KafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
